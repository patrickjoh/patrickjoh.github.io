...
let eventItemData = [{
    ...
    img: "prog2053/images/rick_astley.png",
    alt: "Bilde av Rick Astley",
    buttonimg: "prog2053/images/stjerne_tom.svg"
},
{
    id: "puteslott",
    ...
    img: "prog2053/images/pillow_fort.png",
    alt: "Et puteslott",
    buttonimg: "prog2053/images/stjerne_tom.svg"
},
{
    ...
    img: "prog2053/images/paintball.png",
        ...
        bookmarkedEvents.innerHTML = bookmarks.map((event) => {
            ...
            <li>
                <div id=bookmark-${search.id} class="bookmarkListItem">
                    ...
                    <img class="remove_Bookmark" src="prog2053/images/remove.svg" alt="Rød knapp som fjerner event" >
                </div>
            </li>
            `
...
let update = (id) => {
    ...
    if (search !== undefined) {
        document.getElementById(id).src = "prog2053/images/stjerne_fylt.svg";
        ...
        document.getElementById(id).src = "prog2053/images/stjerne_tom.svg";
